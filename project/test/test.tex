...
\subsubsection{T205a - Assisted Calibration}
\begin{tabular}{| l | p{12cm} |}
    \hline
	Requirement & [Deriving calibration parameters for a Patient] \\ \hline
	Conditions and Procedures & [The patient and a caretaker must both be
present and in possession of an Emotiv device, computer with software
installed and Insteon devices attached.] \\ \hline
...
\begin{tabular}{| l | p{12cm}  |}
	...
	Then, once the test feels they are comfortable enough with the
