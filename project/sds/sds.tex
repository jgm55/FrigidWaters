...
\subsection{Overview}
In the next section is the architectural description. In that section you will find overview of components and modules as well as a description of the system structure and component relationships. In the third section the system interfaces are laid out. This pertains to user interface, data interface, as well as the programming interface. The fourth section is composed of a subsections describing the detailed design of the system. 
